                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="product-checkbox-list">
                                ...
                                ?>
                                    <div class="form-check">
                                        <input class="form-check-input product-checkbox" type="checkbox" name="selected_products[]" value="<?php echo $p['id']; ?>" id="prod_<?php echo $p['id']; ?>" onchange="updateSelectedCount()">
