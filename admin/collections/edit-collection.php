...
<body>
                    ...
                    <form method="POST" enctype="multipart/form-data" id="collectionForm">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="main-product-picker" id="mainProductPicker">
                                <div class="main-product-empty" id="mainProductEmpty" onclick="document.getElementById('mainProductSearch').focus()" <?php echo $collection['main_product_id'] ? 'style="display:none"' : ''; ?>>
                                    <i class="fas fa-search me-2"></i>Click to select the main product for this collection
                                </div>

                                <div class="main-product-card" id="mainProductCard" style="<?php echo $collection['main_product_id'] ? 'display:flex' : 'display:none'; ?>">
                            ...
                            <input type="hidden" name="main_product_id" id="mainProductIdInput" value="<?php echo intval($collection['main_product_id']); ?>">
    ...
    <script>
        ...
        // ─── Main Product Picker ──────────────────────────────────
        // ═══════════════════════════════════════════════════════════
        let mainProductId = <?php echo $collection['main_product_id'] ? intval($collection['main_product_id']) : 'null'; ?>;
        ...
        if (mainProductId) {
            const prod = allProducts.find(p => p.id == mainProductId);
            if (prod) {
                const imgSrc = prod.featured_image
                    ? '../../' + prod.featured_image
                    : '../../assets/images/products/prod_1769666277_feat.png';
