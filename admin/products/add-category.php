...
<head>
    ...
    <style>
        ...
        .preview-img { max-width: 150px; border-radius: 8px; border: 1px solid #ddd; margin-top: 10px; display: none; }
    </style>
</head>
<body>
                        ...
                        <div class="tab-content" id="catTabsContent">
                            ...
                            <div class="tab-pane fade show active" id="basic" role="tabpanel">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" required onkeyup="generateSlug(this.value)">
                                    </div>
                                    <div class="col-md-6 mb-3">
                            ...
                            <div class="tab-pane fade" id="seo" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="seo_keywords" placeholder="keyword1, keyword2, ...">
                                </div>
                                <div class="mb-3">
