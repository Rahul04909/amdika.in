...
<section class="cb-collection-section" aria-labelledby="collection-heading">
    <div class="cb-container">
        ...
        <div class="cb-slider-wrapper">
            <button class="cb-nav cb-prev" aria-label="Previous collection">‹</button>
            <div class="cb-slider">
            ...
            <button class="cb-nav cb-next" aria-label="Next collection">›</button>
        </div>

        <script>
        document.addEventListener('DOMContentLoaded',function(){var s=document.querySelector('.cb-slider'),p=document.querySelector('.cb-prev'),n=document.querySelector('.cb-next');if(!s||!p||!n)return;function a(){var c=s.querySelector('.cb-card');return c?c.offsetWidth+26:226}p.addEventListener('click',function(){s.scrollBy({left:-a(),behavior:'smooth'})});n.addEventListener('click',function(){s.scrollBy({left:a(),behavior:'smooth'})})});
        </script>
