<style>
    ...
    .site-footer {
        ...
        /* Consistent with header accents */
    }
    ...
    <div class="container">
                ...
                <div class="d-flex gap-2">
                    <a href="javascript:void(0)">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/3/3c/Download_on_the_App_Store_Badge.svg"
                            alt="App Store" style="height:35px;">
                    </a>
                    <a href="javascript:void(0)">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg"
                            alt="Google Play" style="height:35px;">
                    </a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-4">
                ...
                <p class="category-text">
                    Mumbai, Delhi, Bengaluru, Hyderabad, Ahmedabad, Chennai, Kolkata, Surat, Pune, Jaipur, Lucknow,
        ...
        <div class="footer-bottom-row">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 mb-3 mb-lg-0 text-lg-center">
                    <div class="fw-bold mb-2 text-secondary" style="font-size: 13px;">Choose from your preferred payment
                        methods</div>
                ...
                <div class="col-lg-4 text-lg-end">
                    ...
                    <div class="social-icons">
                        <a href="javascript:void(0)" class="fb"><i class="fa-brands fa-facebook-f"></i></a>
                        <a href="javascript:void(0)" class="insta"><i class="fa-brands fa-instagram"></i></a>
                        ...
                        <a href="javascript:void(0)" class="yt"><i class="fa-brands fa-youtube"></i></a>
                        <a href="javascript:void(0)" class="in"><i class="fa-brands fa-linkedin-in"></i></a>
                    </div>
                </div>
            </div>
        </div>
